...
INSERT INTO system_scope (scope, description, structured, default_scope, restricted) VALUES
  ...
  ('user/AllergyIntolerance.read', 'Read all AllergyIntolerances accessible by the user', false, false, false),
  ('user/AllergyIntolerance.write', 'Read all AllergyIntolerances accessible by the user', false, false, false),
  ...
  ('user/Immunization.read', 'Read all Immunizations accessible by the user', false, false, false),
  ('user/Immunization.write', 'Write all Immunizations accessible by the user', false, false, false),
  ('user/MedicationOrder.read', 'Read all MedicationOrders accessible by the user', false, false, false),
  ('user/MedicationOrder.write', 'Write all MedicationOrders accessible by the user', false, false, false),
  ...
  ('patient/AllergyIntolerance.read', 'Read all AllergyIntolerance for a given patient', false, false, false),
  ('patient/AllergyIntolerance.write', 'Write all AllergyIntolerance for a given patient', false, false, false),
  ...
  ('patient/Immunization.read', 'Read all Immunizations for a given patient', false, false, false),
  ('patient/Immunization.write', 'Write all Immunizations for a given patient', false, false, false),
  ('patient/MedicationOrder.read', 'Read all MedicationOrders for a given patient', false, false, false),
  ('patient/MedicationOrder.write', 'Write all MedicationOrders for a given patient', false, false, false),
